...
function getOptions(method = 'get', body) {
    const options = {
        method,
        // back4app user specific api reference
        headers: {
            'X-Parse-Application-Id': 'xW9DY1raSnVmN8rKdWfpWeRSJuxHfnXJXebOL87P',
            'X-Parse-REST-API-Key': 'r1yHY7Y8sAdLaihIFUgMJiAApDwg0xAj7OGOAEcK'
